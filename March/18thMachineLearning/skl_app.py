...
model = pickle.load(open(r'D:\Data Science and Machine Learning\March\18thMachineLearning\linear_regression_model.pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience. Built by Bhavana.")
